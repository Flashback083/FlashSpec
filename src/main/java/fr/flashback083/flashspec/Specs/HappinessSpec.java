...
public class HappinessSpec extends SpecValue<String> implements ISpecType {

    private String value;
    private List<String> keys;

    public HappinessSpec(List<String> keys, String value){
    ...
    @Override
    public HappinessSpec parse(@Nullable String s) {
        return new HappinessSpec(this.keys, s);
    }
    ...
    public void apply(Pokemon pokemon) {
        pokemon.setFriendship(Integer.parseInt(this.value));
    }
    ...
    public boolean matches(Pokemon pokemon) {
        if (this.value.startsWith(">")){
            return pokemon.getFriendship() > Integer.parseInt(this.value.split(">")[0]);
    ...
    public SpecValue<String> clone() {
        return new HappinessSpec(this.keys,this.value);
    }
}
