...
public class Ivs31AndMinPercent extends SpecValue<String> implements ISpecType {

    private String value;
    private List<String> keys;

    public Ivs31AndMinPercent(List<String> keys, String value){
    ...
    @Override
    public Ivs31AndMinPercent parse(@Nullable String s) {
        return new Ivs31AndMinPercent(this.keys, s);
    }
    ...
    public SpecValue<String> clone() {
        return new Ivs31AndMinPercent(this.keys,this.value);
    }
