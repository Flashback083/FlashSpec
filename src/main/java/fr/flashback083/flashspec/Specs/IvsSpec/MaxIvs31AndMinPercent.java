...
public class MaxIvs31AndMinPercent extends SpecValue<String> implements ISpecType {

    private String value;
    private List<String> keys;

    public MaxIvs31AndMinPercent(List<String> keys, String value){
    ...
    @Override
    public MaxIvs31AndMinPercent parse(@Nullable String s) {
        return new MaxIvs31AndMinPercent(this.keys, s);
    }
    ...
    public SpecValue<String> clone() {
        return new MaxIvs31AndMinPercent(this.keys,this.value);
    }
    ...
    private int[] calculeIvs(int ivs, int percent){
        ...
        for(ArrayList slots = Lists.newArrayList(0, 1, 2, 3, 4, 5); !slots.isEmpty(); --ivs) {
            ...
            if (ivs>0){
                ...
                iv[slot] = RandomHelper.getRandomNumberBetween(0, 30);
            }
